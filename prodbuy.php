...
$SQL="select prodId, prodQuantity, prodName, prodPicNameLarge, prodDescripLong, prodPrice from Product WHERE prodId=".$prodid;
     ...
     echo "<br><p><b>Rs. ".$arrayp['prodPrice']."</b></p>";
